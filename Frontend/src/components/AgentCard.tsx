...
export function AgentCard({ agent, onClick }: AgentCardProps) {
  ...
  return (
    <div
      className="bg-white border border-slate-200 rounded-xl p-4 cursor-pointer transition-all duration-200 hover:shadow-md hover:border-apsBlue hover:-translate-y-0.5 group"
      ...
      <div className="mb-3">
        <div className="flex justify-between items-center text-xs mb-1.5">
          ...
          <span className={cn('font-bold', floatColorClass)}>
            {fmt(agent.efloat)}
          </span>
        </div>
